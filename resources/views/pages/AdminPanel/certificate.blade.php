...
<div class="col-sm-12 text-left ">
   <h1 class="border-bottom border-bot pt-3 text-2xl font-bold">Barangay Setting</h1>
</div>
                     ...
                     <div class="col-md-12 order-md-1  pt-4" >
                        <form class="needs-validation" name="certform"  id="certform"  method="POST"  enctype="multipart/form-data">
                           ...
                           <div class="text-center button-center d-flex justify-content-center">
                              <button id="certsave" class="btn btn-success col-sm-3 text-center btn-lg btn-block bg-green-900" type="submit">Submit</button>
                           </div>
                        </form>
                     </div>
                  </div>
