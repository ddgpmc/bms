...
use App\Http\Controllers\AdminPanel\OrdinancesController;
...
//Ordinances Module
Route::resource('ordinances', OrdinancesController::class);
Route::get('/adminpanel/ordinances/create', [OrdinancesController::class, 'create'])->name('adminpanel.ordinances.create');
Route::post('/adminpanel/ordinances', [OrdinancesController::class, 'store'])->name('adminpanel.ordinances.store');
Route::get('/adminpanel/ordinances', [OrdinancesController::class, 'index'])->name('adminpanel.ordinances.index');
Route::delete('/adminpanel/ordinances/{ordinance}', [OrdinancesController::class, 'destroy'])->name('adminpanel.ordinances.destroy');
Route::get('/adminpanel/ordinances/{ordinance}/edit', [OrdinancesController::class, 'edit'])->name('adminpanel.ordinances.edit');
Route::put('/adminpanel/ordinances/{ordinance}', [OrdinancesController::class, 'update'])->name('adminpanel.ordinances.update');
...
Route::get('/adminpanel/news/create', [NewsController::class, 'create'])->name('adminpanel.news.create');
Route::post('/adminpanel/news', [NewsController::class, 'store'])->name('adminpanel.news.store');
Route::get('/adminpanel/news', [NewsController::class, 'index'])->name('adminpanel.news.index');
Route::delete('/adminpanel/news/{news}', [NewsController::class, 'destroy'])->name('adminpanel.news.destroy');
Route::get('/adminpanel/news/{news}/edit', [NewsController::class, 'edit'])->name('adminpanel.news.edit');
Route::put('/adminpanel/news/{news}', [NewsController::class, 'update'])->name('adminpanel.news.update');
Route::get('/adminpanel/news', [NewsController::class, 'index'])->name('adminpanel.news'); // Add this line
Route::get('/barangay/news', [NewsController::class, 'residentNews'])->name('barangay.news');
